...
以上代码实现了外部中断信号从GPIO到AFIO到EXTI到NVIC最后CPU的配置。之后我们需要配置中断函数，在STM32中，每个终端通道对应的函数是固定的，j
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTIyNjUxNTYyLDY2MTE1NTE0NCwtNDIxNj
Q2MzAsLTE3NDI4NzIzNzcsLTUxNDU5NjUwNSwtMjA3OTI2ODAy
MSwtNDQ4NTYzMjEzXX0=
-->