...
>寻址:	主机向总线发送从机地址,从主机开始向SDA写入数据的瞬间,SCLjihuo常用是7位地址.剩下的一位^R/W#^代表数据传输的方向,随后主机释放SDA等待从机应答
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzU1NzgwMDkxLC05NjE3ODY0ODIsLTEzOD
QyNjQ0OTYsODA2NDQyMTEyLDE1MDQxMTg1MDIsLTE5OTQ2MDk4
MCwtMTE3Mzg2NDY2N119
-->