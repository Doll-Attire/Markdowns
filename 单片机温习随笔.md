...
以上代码实现了外部中断信号从GPIO到AFIO到EXTI到NVIC最后CPU的配置。之后我们需要配置中断函数，在STM32中，每个终端通道对应的函数是固定的
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjYxMTU1MTQ0LC00MjE2NDYzMCwtMTc0Mj
g3MjM3NywtNTE0NTk2NTA1LC0yMDc5MjY4MDIxLC00NDg1NjMy
MTNdfQ==
-->