...
即 S = 0 	;	 M = 1.0011 	;		 E = 3;
```
同时,这里我们就会发现一件事情，也就是为什么float存储时会发生失真，我们知道小数的二进制是靠不断×2取小数部分再重复的，显然诸如 0.3 的小数，会经历 0.6 -》 0.2 —》0.4 -》0.8 -》0.6的无穷xunhuan
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU4MTE0MzgzMCwxNzg4MzM1Mjk4XX0=
-->